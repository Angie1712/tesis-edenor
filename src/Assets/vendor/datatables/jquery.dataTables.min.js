...
"sPaginationType","sAjaxSource","sAjaxDataProp","iStateDuration","sDom","bSortCellsTop","iTabIndex","fnStateLoadCallback","fnStateSaveCallback","renderer","BuscarDelay","rowId",["iCookieDuration","iStateDuration"],["oBuscar","oanteriorBuscar"],["aoBuscarCols","aoPreBuscarCols"],["iDisplayLength","_iDisplayLength"]]);F(p.oScroll,g,[["sScrollX","sX"],["sScrollXInner","sXInner"],["sScrollY","sY"],["bScrollCollapse","bCollapse"]]);F(p.oLanguage,g,"fnInfoCallback");z(p,"aoDrawCallback",g.fnDrawCallback,
...
this;return this.iterator("table",function(c,d){var e=[];h.each(b[d],function(b,c){e.push([c,a])});c.aaSorting=e})});o("Buscar()",function(a,b,c,d){var e=this.context;return a===k?e.length!==0?e[0].oanteriorBuscar.sBuscar:k:this.iterator("table",function(e){e.oFeatures.bFilter&&ha(e,h.extend({},e.oanteriorBuscar,{sBuscar:a+"",bRegex:b===null?false:b,bSmart:c===null?true:c,bCaseInsensitive:d===null?true:d}),1)})});u("columns().Buscar()","column().Buscar()",function(a,b,c,d){return this.iterator("column",
function(e,f){var g=e.aoPreBuscarCols;if(a===k)return g[f].sBuscar;if(e.oFeatures.bFilter){h.extend(g[f],{sBuscar:a+"",bRegex:b===null?false:b,bSmart:c===null?true:c,bCaseInsensitive:d===null?true:d});ha(e,e.oanteriorBuscar,1)}})});o("state()",function(){return this.context.length?this.context[0].oSavedState:null});o("state.clear()",function(){return this.iterator("table",function(a){a.fnStateSaveCallback.call(a.oInstance,a,{})})});o("state.loaded()",function(){return this.context.length?this.context[0].oLoadedState:
...
a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Next",santerior:"anterior"},sEmptyTable:"No data available in table",sInfo:"Mostrar _START_ to _END_ of _TOTAL_entradas",sInfoEmpty:"Mostrar 0 to 0 of 0entradas",
sInfoFiltered:"(filtered from _MAX_ totalentradas)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Mostrar _MENU_entradas",sLoadingRecords:"Loading...",sProcessing:"Processing...",sBuscar:"Buscar:",sBuscarPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oBuscar:h.extend({},l.models.oBuscar),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",BuscarDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
...
bSortClasses:null,bStateSave:null},oScroll:{bCollapse:null,iBarWidth:0,sX:null,sXInner:null,sY:null},oLanguage:{fnInfoCallback:null},oBrowser:{bScrollOversize:!1,bScrollbarLeft:!1,bBounding:!1,barWidth:0},ajax:null,aanFeatures:[],aoData:[],aiDisplay:[],aiDisplayMaster:[],aIds:{},aoColumns:[],aoHeader:[],aoFooter:[],oanteriorBuscar:{},aoPreBuscarCols:[],aaSorting:null,aaSortingFixed:[],asStripeClasses:null,asDestroyStripes:[],sDestroyWidth:0,aoRowCallback:[],aoHeaderCallback:[],aoFooterCallback:[],
...
sScrollHeadInner:"dataTables_scrollHeadInner",sScrollBody:"dataTables_scrollBody",sScrollFoot:"dataTables_scrollFoot",sScrollFootInner:"dataTables_scrollFootInner",sHeaderTH:"",sFooterTH:"",sSortJUIAsc:"",sSortJUIDesc:"",sSortJUI:"",sSortJUIAscAllowed:"",sSortJUIDescAllowed:"",sSortJUIWrapper:"",sSortIcon:"",sJUIHeader:"",sJUIFooter:""});var Mb=l.ext.pager;h.extend(Mb,{simple:function(){return["anterior","next"]},full:function(){return["first","anterior","next","last"]},numbers:function(a,b){return[ja(a,
b)]},simple_numbers:function(a,b){return["anterior",ja(a,b),"next"]},full_numbers:function(a,b){return["first","anterior",ja(a,b),"next","last"]},first_last_numbers:function(a,b){return["first",ja(a,b),"last"]},_numbers:ja,numbers_length:7});h.extend(!0,l.ext.renderer,{pageButton:{_:function(a,b,c,d,e,f){var g=a.oClasses,j=a.oLanguage.oPaginate,i=a.oLanguage.oAria.paginate||{},l,m,o=0,s=function(b,d){var k,u,t,r,v=g.sPageButtonDisabled,w=function(b){Va(a,b.data.action,true)};k=0;for(u=d.length;k<
u;k++){r=d[k];if(Array.isArray(r)){t=h("<"+(r.DT_el||"div")+"/>").appendTo(b);s(t,r)}else{l=null;m=r;t=a.iTabIndex;switch(r){case "ellipsis":b.append('<span class="ellipsis">&#x2026;</span>');break;case "first":l=j.sFirst;if(e===0){t=-1;m=m+(" "+v)}break;case "anterior":l=j.santerior;if(e===0){t=-1;m=m+(" "+v)}break;case "next":l=j.sNext;if(f===0||e===f-1){t=-1;m=m+(" "+v)}break;case "last":l=j.sLast;if(f===0||e===f-1){t=-1;m=m+(" "+v)}break;default:l=a.fnFormatNumber(r+1);m=e===r?g.sPageButtonActive:
