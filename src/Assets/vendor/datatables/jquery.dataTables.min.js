...
a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Siguiente",santerior:"Anterior"},sEmptyTable:"No data available in table",sInfo:"Mostrar _START_ a _END_ de _TOTAL_ entradas",sInfoEmpty:"Mostrar 0 a 0 de 0 entradas",
sInfoFiltered:"(filtered from _MAX_ total entradas)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Mostrar _MENU_entradas",sLoadingRecords:"Loading...",sProcessing:"Processing...",sBuscar:"Buscar:",sBuscarPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oBuscar:h.extend({},l.models.oBuscar),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",BuscarDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
...
u;k++){r=d[k];if(Array.isArray(r)){t=h("<"+(r.DT_el||"div")+"/>").appendTo(b);s(t,r)}else{l=null;m=r;t=a.iTabIndex;switch(r){case "ellipsis":b.append('<span class="ellipsis">&#x2026;</span>');break;case "first":l=j.sFirst;if(e===0){t=-1;m=m+(" "+v)}break;case "anterior":l=j.santerior;if(e===0){t=-1;m=m+(" "+v)}break;case "Siguiente":l=j.sNext;if(f===0||e===f-1){t=-1;m=m+(" "+v)}break;case "last":l=j.sLast;if(f===0||e===f-1){t=-1;m=m+(" "+v)}break;default:l=a.fnFormatNumber(r+1);m=e===r?g.sPageButtonActive:
